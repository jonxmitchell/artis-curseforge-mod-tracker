...
!define VERSIONWITHBUILD "1.0.2.0"
...
!define SIDEBARIMAGE ""
!define HEADERIMAGE ""
!define MAINBINARYNAME "artis-curseforge-mod-tracker"
!define MAINBINARYSRCPATH "C:\Users\jonxm\Documents\Repos\artis-curseforge-mod-tracker\src-tauri\target\release\artis-curseforge-mod-tracker.exe"
!define BUNDLEID "com.artis-curseforge-mod-tracker"
!define COPYRIGHT ""
...
Var DeleteSettingsCheckboxState
...
Function un.ConfirmShow
    ...
    ${If} $(^RTL) == 1
      ...
      System::Call 'USER32::CreateWindowEx(i${__NSD_CheckBox_EXSTYLE}|${WS_EX_LAYOUTRTL},t"${__NSD_CheckBox_CLASS}",t "Delete curseforge_tracker.db file (this will also delete your saved configurations, this cannot be undone)",i${__NSD_CheckBox_STYLE},i 50,i 130,i 400, i 25,i$1,i0,i0,i0)i.s'
    ${Else}
      ...
      System::Call 'USER32::CreateWindowEx(i${__NSD_CheckBox_EXSTYLE},t"${__NSD_CheckBox_CLASS}",t "Delete curseforge_tracker.db file (this will also delete your saved configurations, this cannot be undone)",i${__NSD_CheckBox_STYLE},i 0,i 130,i 400, i 25,i$1,i0,i0,i0)i.s'
    ${EndIf}
...
Function un.ConfirmLeave
    ...
    SendMessage $DeleteSettingsCheckbox ${BM_GETCHECK} 0 0 $DeleteSettingsCheckboxState
FunctionEnd
...
Section Uninstall
  ...
  FileOpen $0 "$TEMP\uninstall_log.txt" w
  FileWrite $0 "Uninstallation started$\n"

  ; Delete the app directory and its content from disk
  Delete "$INSTDIR\${MAINBINARYNAME}.exe"
  FileWrite $0 "Deleted $INSTDIR\${MAINBINARYNAME}.exe$\n"

  Delete "$INSTDIR\uninstall.exe"
  FileWrite $0 "Deleted $INSTDIR\uninstall.exe$\n"

  RMDir "$INSTDIR"
  FileWrite $0 "Removed $INSTDIR$\n"
  ...
  FileWrite $0 "Removed start menu shortcuts$\n"

  ; Remove desktop shortcuts
  Delete "$DESKTOP\${MAINBINARYNAME}.lnk"
  FileWrite $0 "Removed desktop shortcut$\n"
  ...
  !endif
  FileWrite $0 "Removed registry information$\n"
  ...
  ${If} $DeleteAppDataCheckboxState == ${BST_CHECKED}
    ...
    FileWrite $0 "Deleted app data$\n"
  ${EndIf}

  ; Delete curseforge_tracker.db file
  ${If} $DeleteSettingsCheckboxState == ${BST_CHECKED}
    SetShellVarContext current
    FileWrite $0 "Attempting to delete curseforge_tracker.db$\n"
    
    ; Try to delete the file
    Delete "$LOCALAPPDATA\artis-curseforge-mod-tracker\curseforge_tracker.db"
    
    ; Check if the file still exists
    ${If} ${FileExists} "$LOCALAPPDATA\artis-curseforge-mod-tracker\curseforge_tracker.db"
      FileWrite $0 "Failed to delete curseforge_tracker.db. File may be in use.$\n"
      MessageBox MB_OK "Failed to delete curseforge_tracker.db. The file may be in use. Please close all related applications and try again."
    ${Else}
      FileWrite $0 "curseforge_tracker.db successfully deleted$\n"

      ; Remove the bundle folder after successfully deleting curseforge_tracker.db
      RMDir /r "$LOCALAPPDATA\artis-curseforge-mod-tracker"
      FileWrite $0 "Removed bundle folder $LOCALAPPDATA\artis-curseforge-mod-tracker$\n"
    ${EndIf}
  ${Else}
    FileWrite $0 "curseforge_tracker.db deletion not requested$\n"
  ${EndIf}
